...
For our case we just need one Student POJO since we have only one table `students` in our database. It contains a default and a parametrized constructor, getter / setter methods, and a toString method.
